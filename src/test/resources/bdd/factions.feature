...
Feature: Faction-level features of the X-Wing library
  ...
  Scenario Outline: Get a list of ships in the faction
    ...
    | "Galactic Republic" | arc170starfighter, btlbywing, cr90corelliancorvette, delta7aethersprite, delta7baethersprite, eta2actis, gauntletfighter, laatigunship, nabooroyaln1starfighter, nimbusclassvwing, v19torrentstarfighter |
    ...
    | "Scum and Villainy" | aggressorassaultfighter, btla4ywing, croccruiser, customizedyt1300lightfreighter, escapecraft, fangfighter, firesprayclasspatrolcraft, g1astarfighter, gauntletfighter, hwk290lightfreighter, jumpmaster5000, kihraxzfighter, lancerclasspursuitcraft, m3ainterceptor, m12lkimogilafighter, modifiedtielnfighter, quadrijettransferspacetug, scurrgh6bomber, st70assaultship, starviperclassattackplatform, tridentclassassaultship, yv666lightfreighter, z95af4headhunter |
    | "Separatist Alliance" | belbullab22starfighter, croccruiser, droidtrifighter, firesprayclasspatrolcraft, gauntletfighter, hmpdroidgunship, hyenaclassdroidbomber, nantexclassstarfighter, sithinfiltrator, tridentclassassaultship, vultureclassdroidfighter |
