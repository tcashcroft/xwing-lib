...
Feature: Faction-level features of the X-Wing library
  ...
  Scenario Outline: Get a list of ships in the faction
    ...
    | "Galactic Republic" | arc170starfighter, btlbywing, clonez95headhunter, cr90corelliancorvette, delta7aethersprite, delta7baethersprite, eta2actis, gauntletfighter, laatigunship, nabooroyaln1starfighter, nimbusclassvwing, syliureclasshyperspacering, v19torrentstarfighter |
  ...
  Scenario Outline: Get a list of pilots with the same chassis
    ...
    Examples:
    | chassis | pilotList |
    | "ARC_170_STARFIGHTER" | sinker, jag, jag-siegeofcoruscant, oddball-arc170starfighter, oddball-siegeofcoruscant, wolffe, wolffe-siegeofcoruscant, 104thbattalionpilot, squadsevenveteran, garvendreis, ibtisam, norrawexley, sharabey |
  ...
  Scenario Outline: Get a list of pilots with the same chassis and faction
    ...
    | "ARC_170_STARFIGHTER" | "galacticrepublic" | sinker, jag, jag-siegeofcoruscant, oddball-arc170starfighter, oddball-siegeofcoruscant, wolffe, wolffe-siegeofcoruscant, 104thbattalionpilot, squadsevenveteran |
